...
data_path = project_root / "post-bias-reference" / "data" / "processed" / "spy_event_dataset.csv"
results_dir = project_root / "post-bias-reference" / "results"
...
with open(results_dir / "baseline_metrics.txt", "w", encoding="utf-8") as f:
    f.write(f"1 candle post extreme event taken as reference for continuation or reversal:\n\n")
